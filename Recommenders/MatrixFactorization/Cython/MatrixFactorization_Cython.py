...
class MatrixFactorization_WARP_Cython(_MatrixFactorization_Cython):
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_WARP_Cython, self).__init__(
            *pos_args, algorithm_name="MF_WARP", **key_args
        )
...
class MatrixFactorization_SVDpp_Cython(_MatrixFactorization_Cython):
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_SVDpp_Cython, self).__init__(
            *pos_args, algorithm_name="SVD++", **key_args
        )
